...
const Section = () => {
    return (
        <div>
            <div className='lg:flex justify-around lg:px-40 py-28 dark:text-white'>
                <div className='text-center' >
                    <img className='mx-40 md:ml-[320px]' src={img} alt="" />
                ...
                <div className='text-center'>
                    <img  className='lg:mx-52 mx-40 md:ml-[320px]' src={img2} alt="" />
                ...
                <div className='text-center'>
                    <img  className=' mx-40 md:ml-[320px]' src={img3} alt="" />
