...
const Register = () => {
    const { createRegister, updateUserDetails, signInWithGoogle, signInFacebook } = useContext(AuthProvider);
    ...
    return (
        <div className="bg-[#CB6161] dark:bg-gray-700 my-10 rounded-xl lg:h-[950px] py-12 lg:w-[600px] mx-auto px-28" >
            <form onSubmit={handleRegi} >
                <div>
                    <p className="lg:text-3xl text-xl font-semibold text-black dark:text-white mb-3">Email</p>
                    <input type="email" name="email" placeholder="Enter your email" className="border lg:p-3 p-2 lg:w-[400px] w-[250px]" />
                </div>
                <div>
                    <p className="lg:text-3xl text-xl font-semibold text-black dark:text-white mb-3">Your Name</p>
                    <input type="name" name="name" placeholder="Enter your name" className="border lg:p-3 p-2 lg:w-[400px] w-[250px]" />
                </div>
                <div>
                    <p className="lg:text-3xl text-xl font-semibold text-black dark:text-white mb-3">Photo Url</p>
                    <input type="text" name="photo" placeholder="Enter photo URL" className="border lg:p-3 p-2 lg:w-[400px] w-[250px]" />
                </div>

                <div>
                    <p className="lg:text-3xl text-xl font-semibold text-black dark:text-white mb-3">Password</p>
                ...
                <div className="lg:text-xl text-sm mt-3 text-center font-semibold text-black dark:text-white" >
                    <p>
                        All ready have an account? <br /><div className="text-center"> Please <Link to='/login' className="hover:underline ">Login</Link></div>
